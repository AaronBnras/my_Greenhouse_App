                                      ...
                                      SleekCircularSlider(
                                        appearance: CircularSliderAppearance(
                                            ...
                                            customColors: CustomSliderColors(
                                                trackColor: const Color(0xffef6c00),
                                                progressBarColor: const Color(0xffffb74d),
                                                shadowColor: const Color(0xffffb74d),
                                                shadowMaxOpacity: 0.3, //);
                                                shadowStep: 10),
                                            infoProperties: InfoProperties(
                                                bottomLabelStyle: const TextStyle(
                                                    color: Color(0xff6DA100),
                                                    fontSize: 20,
                                                    fontWeight: FontWeight.w600),
                                      ...
                                      SleekCircularSlider(
                                        appearance: CircularSliderAppearance(
                                            customWidths: CustomSliderWidths(
                                                ...
                                                shadowWidth: 40),
                                            customColors: CustomSliderColors(
                                                trackColor: const Color(0xff0277bd),
                                                progressBarColor: const Color(0xff4FC3F7),
                                                shadowColor: const Color(0xffB2EBF2),
                                                shadowMaxOpacity: 0.3, //);
                                                shadowStep: 10),
                                            infoProperties: InfoProperties(
                                                bottomLabelStyle: const TextStyle(
                                      ...
                                      SleekCircularSlider(
                                        appearance: CircularSliderAppearance(
                                            customWidths: CustomSliderWidths(
                                                ...
                                                shadowWidth: 40),
                                            customColors: CustomSliderColors(
                                                trackColor: const Color(0xff6AA84F),
                                                progressBarColor: const Color(0xff93C47D),
                                                shadowColor: const Color(0xff93C47D),
                                                shadowMaxOpacity: 0.3, //);
                                                shadowStep: 10),
                                            infoProperties: InfoProperties(
                                                bottomLabelStyle: const TextStyle(
